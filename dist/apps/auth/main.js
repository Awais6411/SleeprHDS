...
const user_entity_1 = __webpack_require__(/*! ./users/entity/user.entity */ "./apps/auth/src/users/entity/user.entity.ts");
...
__decorate([
    (0, common_1.UseGuards)(local_auth_guard_1.LocalAuthGurd),
    (0, common_1.Post)('login'),
    __param(0, (0, common_2.CurrentUser)()),
    __param(1, (0, common_1.Res)({ passthrough: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof user_entity_1.UserEntity !== "undefined" && user_entity_1.UserEntity) === "function" ? _b : Object, typeof (_c = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _c : Object]),
        ...
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                useFactory: (configServcie) => ({
                    secret: configServcie.get('JWT_SECRET'),
                    signOptions: {
...
let AuthService = class AuthService {
    constructor(configSevcie, jwtService) {
        this.configSevcie = configSevcie;
    ...
    login(user, response) {
        try {
            ...
            expires.setSeconds(expires.getSeconds() + this.configSevcie.get('JWT_EXPIRATION'));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LocalAuthGurd = void 0;
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
class LocalAuthGurd extends (0, passport_1.AuthGuard)('local') {
}
exports.LocalAuthGurd = LocalAuthGurd;
...
/***/ "./apps/auth/src/users/entity/user.entity.ts":
/*!***************************************************!*\
  !*** ./apps/auth/src/users/entity/user.entity.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let UserEntity = class UserEntity extends common_1.AbstractEntity {
};
...
const user_entity_1 = __webpack_require__(/*! ./entity/user.entity */ "./apps/auth/src/users/entity/user.entity.ts");
const typeorm_1 = __webpack_require__(/*! @nestjs/typeorm */ "@nestjs/typeorm");
const typeorm_2 = __webpack_require__(/*! typeorm */ "typeorm");
let UserRepository = class UserRepository extends common_1.AbstractRepository {
...
__decorate([
    ...
    __param(0, (0, common_2.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof user_entity_1.UserEntity !== "undefined" && user_entity_1.UserEntity) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
...
exports.UsersModule = UsersModule = __decorate([
    (0, common_1.Module)({
        imports: [common_2.DatabaseModule, common_2.DatabaseModule.forFeature([user_entity_1.UserEntity])],
...
let UsersService = class UsersService {
    ...
    async varifyUser(email, password) {
        ...
        if (!passwordIsValid) {
            throw new common_1.UnauthorizedException('Credentails are not valid.');
        }
        return user;
    }
};
